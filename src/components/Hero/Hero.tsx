        ...
        {isRetro ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-20">
                  ...
                  <div className="lg:col-span-7 flex flex-col gap-5">
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                      ...
                      <Link
                        to="/macos"
                        className="retro-btn pattern-action-btn px-4 py-2 text-xs font-pixel flex items-center gap-2 bg-purple-900/40 text-purple-300 border border-purple-400"
                      >
                        <FaApple className="w-3.5 h-3.5 text-white" />
                        <span>MACOS_SEQUOIA.APP</span>
                      </Link>
                      <Link
                        to="/windows11"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch pt-2">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between p-6 rounded-lg bg-[#0e0e12] border border-white/10">
                ...
                <div className="pt-4 border-t border-white/10 flex flex-wrap gap-2.5 items-center">
                  ...
                  <Link
                    to="/macos"
                    className="px-3 py-1.5 rounded bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/40 text-xs font-mono flex items-center gap-2 transition-all"
                  >
          ...
          <div className="grid grid-cols-12 gap-4 mb-12">
            ...
            <div className="col-span-12 lg:col-span-7 bento-tile p-6 sm:p-8 flex flex-col justify-between gap-6 min-h-[380px]">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <Link
                  to="/macos"
                  className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-purple-600/30 to-blue-600/30 hover:from-purple-600/40 hover:to-blue-600/40 border border-white/20 text-white font-semibold text-xs flex items-center gap-2 transition-all shadow-md active:scale-95"
                >
                  <FaApple className="w-3.5 h-3.5 text-white" />
          ...
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
              ...
              <Link
                to="/macos"
                className="px-4 py-2 rounded-full bg-purple-500/15 hover:bg-purple-500/25 text-purple-200 border border-purple-500/30 text-xs font-mono flex items-center gap-2 transition-all"
              >
                <FaApple className="w-3 h-3 text-white" />
                <span>macOS Sequoia</span>
              </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
              ...
              <div className="lg:col-span-7 flex flex-col gap-6">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  ...
                  <Link
                    to="/macos"
                    className="px-5 py-3 border-2 border-white bg-[#1a1a24] text-white font-mono font-bold text-xs uppercase flex items-center gap-2 shadow-brutal-sm hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
                  >
                    <FaApple className="w-4 h-4 text-white" />
                    <span>[MACOS_SEQUOIA]</span>
                  </Link>
                  <Link
                    to="/windows11"
